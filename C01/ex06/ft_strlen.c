...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/11 15:15:46 by hkeles            #+#    #+#             */
/*   Updated: 2024/06/21 21:10:41 by hkeles           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int ft_strlen(char *str) // ft_strlen (recursive)
{
...
int ft_strlen(char *str) // ft_strlen (iterative)
{
